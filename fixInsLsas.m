function [ argOut ] = fixInsLsas(dirMap,envs,objs,objData,objtype,ranges,aspects,chirp,runlen )
        ...
        for r = 1:length(ranges)
            for a = 1:length(aspects)
                ...
                if(strfind(sigName,'.replica'))
                    ...
                    hs{8} = [num2str(BW/2+chirp(1)),' ',num2str(BW),' 6 8 6 '];%'E:\Synth_AC_Tools\ins\TREX.dat';% % Carrier and BW/ file name
                end
                ...
                if(strcmp(char(objtype(o)),'file'))
                    ...
                    hs{14} = char(objs(o)); %['..\..\..\..\..\ffn\' char(objs(o)) '.ffn'];
                    hs{15} = 'freefield';
                end
